...
const Hero = () => {
  return (
    <div
      className="relative w-full flex justify-center items-center flex-col h-screen"
    >
      <img 
      ...
      <h1 className="text-white text-6xl font-bold relative z-20 text-center">🤸 FITKIDPEDIA 📖</h1>
      <h2 className="text-white text-2xl font-semibold relative z-20 my-3 mx-12">
