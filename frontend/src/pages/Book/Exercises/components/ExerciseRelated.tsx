...
function ExerciseRelated({ id, ruta, dificultad, imageUrl, name }: ExerciseCardProps) {
  ...
  return (
    <div key={id} className="relative cursor-pointer h-48 lg:w-80 w-80 hover:shadow-xl hover:scale-105 transition" onClick={() => navigate(ruta)}>
...
export default ExerciseRelated;
