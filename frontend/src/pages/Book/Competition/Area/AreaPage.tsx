...
const AreaPage = () => {
  ...
  <p className="text-lg text-gray-700 font-light px-4 py-2 leading-loose bg-orange-50 shadow-md rounded-md">
    El <span className="font-bold">área de competición</span> debe ser de al menos <span className="font-bold">8x8 metros hasta un máximo de 10x10 metros.</span><br />  Esta área debe estar <span className="font-bold">claramente demarcada</span>, utilizando líneas pintadas o cintas adhesivas, sin objetos que puedan provocar accidentes.<br></br> El suelo debe estar cubierto con una <span className="font-bold">alfombra profesional adecuada</span> para la competición, asegurando así la <span className="font-bold">seguridad  para las actuaciones </span> de los jóvenes atletas.
</p>
