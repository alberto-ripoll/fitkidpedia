...
const Footer = () => {
  return (
    <footer className="w-full bg-black text-gray-700 text-center p-4 mt-8 fixed bottom-0 left-0 right-0 z-10 flex items-center justify-between border-gray-50">
      <div className="flex-grow text-white md:text-center text-start font-light">
